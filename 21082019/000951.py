...
print "usemos otra lista y cambiemos valores"

cien_metros_planos=["martin","vicho","anibal","matias"]
print "asi comienza la carrera 100 m planos"

primer_lugar=cien_metros_planos[3]
segundo_lugar=cien_metros_planos[1]
tercer_lugar=cien_metros_planos[2]
cuarto_lugar=cien_metros_planos[0]

cien_metros_planos[0]=primer_lugar
cien_metros_planos[1]=segundo_lugar
cien_metros_planos[2]=tercer_lugar
cien_metros_planos[3]=cuarto_lugar
#nos deberia imprimir en orden de matias,vicho,anibal,martin
print "el resultado es:"
print cien_metros_planos

#intento 9


print "carrera a las duchas"

cien_metros_planos[0],cien_metros_planos[3]=cien_metros_planos[3],cien_metros_planos[0]
print cien_metros_planos
print "matias se fue caminando a las duchas y martin queria su revancha"

print "se termina la nivelacion de hoy"